...
from model import TransE, HeteroRGCN, HeteroLinkPredictionModel
...
parser.add_argument('--k_core', type=int, default=-1, help='k for the k-core graph') 
...
if args.config_path:
    args = set_config_args(args, args.config_path, args.dataset_name, 'DDTExplanier')
...
state = torch.load(f'{args.saved_model_dir}/TransE_{args.saved_model_name}.pth', map_location='cpu')
...
if args.save_explanation:
    ...
    saved_edge_explanation_file = f'DDTExp_{args.saved_model_name}_pred_edge_to_comp_g_edge_mask'
    saved_path_explanation_file = f'DDTExp_{args.saved_model_name}_pred_edge_to_paths'
