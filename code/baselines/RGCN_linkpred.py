...
parser.add_argument('--saved_model_dir', type=str, default='code/baselines/saved_models', help='Where to save the model')
...
if args.save_model:
    ...
    torch.save(model.state_dict(), output_dir.joinpath(f"RGCN_{args.dataset_name}_model.pth"))
