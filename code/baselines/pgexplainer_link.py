...
for i in tqdm(test_ids):
    ...
    with torch.no_grad():
        ...
        if pred:
            comp_g_edge_mask_dict = pgexplainer.explain(src_nid, tgt_nid, mp_g, trans)
...
if args.save_explanation:
    ...
    saved_edge_explanation_file = f'{args.gnn_mtype}_pgexp_{args.saved_model_name}_pred_edge_to_comp_g_edge_mask'
