...
for i in tqdm(test_ids):
    ...
    if pred:
        comp_g_edge_mask_dict = gnnexplainer.explain(src_nid, tgt_nid, mp_g, args.num_hops, trans)
...
if args.save_explanation:
    ...
    saved_edge_explanation_file = f'{args.gnn_mtype}_gnnexp_{args.saved_model_name}_pred_edge_to_comp_g_edge_mask'
