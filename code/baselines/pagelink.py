...
from baseline_explainer import PaGELink
...
parser.add_argument('--gnn_mtype', type=str, default='TransE', choices=['RGCN', 'TransE'],
...
if args.save_explanation:
    ...
    saved_edge_explanation_file = f'{args.gnn_mtype}_pagelink_{args.saved_model_name}_pred_edge_to_comp_g_edge_mask'
    saved_path_explanation_file = f'{args.gnn_mtype}_pagelink_{args.saved_model_name}_pred_edge_to_paths'
